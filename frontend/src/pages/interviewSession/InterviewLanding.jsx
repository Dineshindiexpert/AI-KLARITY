...
const InterviewLanding = () => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <FileEarmarkBreakFill className="text-white" size={40}/>
          </div>
          ...
          >
            To start your AI-powered mock interview, upload your resume first.
            Our engine will analyze your skills and generate personalized
            technical questions.
          </p>

          {/* FEATURES */}
          <div className="text-start mb-4">
            <div style={featureStyle}>✓ AI Resume Analysis</div>
            <div style={featureStyle}>✓ Skill Extraction</div>
            <div style={featureStyle}>✓ Personalized Questions</div>
            <div style={featureStyle}>✓ Real Interview Simulation</div>
          </div>
  ...
  return (
    <div className="min-vh-100 py-5" style={{ background: "#0B0F19" }}>
      <Container>
        {/* HEADER */}
        ...
        <div className="text-center mb-5">
          ...
          <h1 className="text-white fw-bold">Technical Interview Simulator</h1>
          ...
          >
            Personalized interview generated from your resume, skills and target
            job role.
          </p>
        </div>
          ...
          <Col lg={7}>
            ...
            >
              <div className="d-flex gap-3 align-items-center">
                ...
                >
                  <CheckCircleFill size={24} color="#34D399" />
                </div>

                <div>
                  <h5 className="text-white">Resume Successfully Analyzed</h5>
            ...
            >
              <div className="d-flex gap-3 align-items-center">
                <BarChartFill color="#60A5FA" size={24} />
            ...
            <Card
              ...
              style={{ background: "#111827" }}
            >
              <h5 className="text-white mb-3">Skills Detected</h5>
            ...
            <Card
              ...
              style={{ background: "#111827" }}
            >
              <h5 className="text-white mb-4">Select Target Role</h5>
          ...
          <Col lg={5}>
            ...
            >
              <div className="d-flex gap-3 mb-4">
                ...
                <h5 className="text-white">Interview Guidelines</h5>
              </div>
