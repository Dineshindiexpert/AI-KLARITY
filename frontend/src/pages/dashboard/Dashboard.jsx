...
import { Target, TrendingUp, Video, Award, Stars } from "lucide-react";
    ...
    <div style={{ background: "#0B1220", minHeight: "100vh" }}>
      <Container fluid className="px-4 py-4">
        ...
        <Row className="align-items-center mb-4">
          ...
          <Col xs="auto">
            <GradientBtn onClick={() => navigate("/interview")}>
              <Stars size={25} className="me-2"/> Start New Mock Interview
            </GradientBtn>
          </Col>
        </Row>
        ...
        <Row className="g-4 mb-4">
          ...
          <Col lg={3}>
            <div style={cardStyle} className="p-4 h-100 position-relative">
              ...
              <div className="mt-3">
                <p className="text-secondary mb-1 text-center text-white">
                  Resume Score
                </p>
        ...
        <Row className="g-4 mb-4 align-items-stretch">
          ...
          <Col lg={8}>
            <Card style={cardStyle} className="p-3 h-100">
              <h5 className="mb-3">
                <span>
                  <TrendingUp size={40} className="me-2 text-success" />
                </span>{" "}
